...
{
	HBITMAP hBitmap = (HBITMAP)::LoadImage(GetApp()->m_hInstance, MAKEINTRESOURCE(IDB_MENU_BUTTON), IMAGE_BITMAP, 0, 0, LR_DEFAULTCOLOR|LR_DEFAULTSIZE|LR_LOADTRANSPARENT);
	//bBitmap.LoadMappedBitmap(IDB_MENU_BUTTON);
	...
	pDC->DrawState( pt, CSize( 9, 6 ), hBitmap, 
