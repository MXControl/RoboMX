...
$Log: ListViewCtrlEx.cpp,v $
Revision 1.1  2004/08/08 09:25:06  tcwinkler
0.3a
...
int CListCtrlEx::AddItem(int nIcon, LPCTSTR pszText, ...)
{

    const int nIndex = InsertItem(LVIF_IMAGE|LVIF_PARAM|LVIF_TEXT, GetItemCount(), pszText, INDEXTOSTATEIMAGEMASK(1), LVIS_STATEIMAGEMASK, nIcon, 0);
