...
public:
	...
	bool	HasCapture;
	BOOL	DoCreate(CWnd *parent, int x, int y, int cx, int cy, CString sFileName, CString sPath ); // Yogesh Jagota
...
protected:
	...
	DECLARE_MESSAGE_MAP()
public:
	void DisplayTool(CString strText);
};
