...
BEGIN_MESSAGE_MAP(CPeerCfg, CCfgDlg)
	ON_EN_CHANGE(IDC_DEFTOPIC, OnEnChangeDeftopic)
	ON_EN_CHANGE(IDC_DEFMOTD, OnEnChangeDefmotd)
	ON_EN_CHANGE(IDC_KEYMSG, OnEnChangeKeymsg)
END_MESSAGE_MAP()
...
BOOL CPeerCfg::OnInitDialog(void)
{
	...
	m_mToolTip.AddControlInfo(IDC_DEFTOPIC, IDS_TOOL_SERVERVARIABLES);
	m_mToolTip.AddControlInfo(IDC_DEFMOTD, IDS_TOOL_SERVERVARIABLES);
	m_mToolTip.AddControlInfo(IDC_KEYMSG, IDS_TOOL_SERVERVARIABLES);
...
BOOL CPeerCfg::PreTranslateMessage( MSG *pMsg )
{
...
void CPeerCfg::OnEnChangeDeftopic()
{

	m_mToolTip.ShowToolTip(IDC_DEFTOPIC);
}

void CPeerCfg::OnEnChangeDefmotd()
{

	m_mToolTip.ShowToolTip(IDC_DEFMOTD);
}

void CPeerCfg::OnEnChangeKeymsg()
{

	m_mToolTip.ShowToolTip(IDC_KEYMSG);
}
