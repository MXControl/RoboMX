...
protected:
	...
	afx_msg void OnBnClickedPlayPm();
	afx_msg void OnBnClickedConnectedNo();
	afx_msg void OnBnClickedDisconnectedNo();
	afx_msg void OnBnClickedTopicNo();
	afx_msg void OnBnClickedMotdNo();
	afx_msg void OnBnClickedRedirectNo();
	afx_msg void OnBnClickedStartNo();
	afx_msg void OnBnClickedErrorNo();
	afx_msg void OnBnClickedPmNo();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
